...
if __name__ == "__main__":
    ...
    df_imputed = drop_rows_with_nulls(df, ['customer_id', 'email'])
    ...
    df_imputed = impute_forward_fill(df_imputed, ['last_updated'])
    
    # Document decisions
    print("\nStep 3: Documenting imputation decisions...")
    document_imputation_decisions(df, df_imputed)
    ...
    df_imputed.to_csv('data/processed/cleaned_data.csv', index=False)
