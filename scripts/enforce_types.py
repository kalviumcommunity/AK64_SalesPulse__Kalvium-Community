...
def cast_columns_to_types(df, type_mapping):
    ...
    for col, target_dtype in type_mapping.items():
        ...
        try:
            ...
            print(f"[ERR] {col}: Conversion failed - {e}")
            raise
    ...
    for col in currency_columns:
        ...
        try:
            ...
            if failed_conversions > 0:
                print(f"[WARN] {col}: {failed_conversions} values could not be converted to numeric")
            
            print(f"[OK] {col}: Stripped symbols, converted to float")
...
def convert_integers_to_boolean(df, boolean_columns):
    ...
    for col in boolean_columns:
        ...
        try:
            ...
            print(f"[OK] {col}: Converted to boolean")
...
if __name__ == "__main__":
    ...
    print("\n[OK] Typed data saved to data/processed/typed_data.csv")
