...
- **Example**: 2025-01-15
- **Null Handling**: UTC timezone - never null
- **Related KPI**: Sales velocity, daily sales tracking
- **Updates**: Recorded at transaction time
...
### flag_churn
- **Type**: Integer
- **Business Meaning**: Whether customer left within 90 days
- **Example**: 0
- **Null Handling**: Derived field, nulls treated as 0
- **Related KPI**: Churn rate prediction, retention rate
- **Updates**: Updated 90 days after transaction
...
- **Formula**: SUM(trnx_amt) over all transactions for a customer_id
- **Related Columns**: trnx_amt, customer_id
- **Why It Matters**: Assesses long-term value of acquiring customers
- **Update Frequency**: Monthly
